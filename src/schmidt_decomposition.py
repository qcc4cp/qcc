...
def compute_eigvals(psi, expected_nonzero):
  ...
  #
  nonzero = np.sum(eigvals0 > 1e-6)
  if nonzero != expected_nonzero:
    raise AssertionError('Number of non-zero eigvals incorrect.')
...
def main(argv):
  ...
  print('Schmidt Decomposition and Entanglemen Test.')
