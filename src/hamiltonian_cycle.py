...
class Graph:
  ...
  def __init__(self, num_vertices: int, expected: bool, desc: str, edges: list):
...
def main(argv):
  ...
  build_circuit(Graph(3, True, 'triangle', [(0, 1), (1, 2), (2, 1)]))
  build_circuit(Graph(4, True, 'rect', [(0, 1), (1, 2), (2, 3), (3, 0)]))
  build_circuit(Graph(4, True, 'rect+diag', [(0, 1), (1, 2), (2, 3), (3, 0), (0, 2)]))  
  build_circuit(Graph(5, True, 'loop-5', [(0, 1), (1, 2), (2, 3), (3, 4), (4, 5)]))
  build_circuit(Graph(5, True, 'loop-5+diag', [(0, 1), (1, 2), (0, 2), (2, 3), (3, 4), (4, 5)]))      
  build_circuit(Graph(4, False, 'line', [(0, 1), (1, 2), (2, 3)]))  
  build_circuit(Graph(5, False, 'triangle with stray 0', [(0, 1), (1, 2), (2, 1), (0, 4)]))
  build_circuit(Graph(5, False, 'triangle with stray 1', [(0, 1), (1, 2), (2, 1), (1, 4)]))
  build_circuit(Graph(5, False, 'triangle with stray 2', [(0, 1), (1, 2), (2, 1), (2, 4)]))    
  build_circuit(Graph(4, False, 'star formation', [(0, 1), (0, 2), (0, 3)]))
  build_circuit(Graph(4, False, 'two lines', [(0, 1), (2, 3)]))
  build_circuit(Graph(5, False, 'two lines with stray', [(0, 1), (1, 2), (2, 3), (1, 4)]))
  build_circuit(Graph(5, True, 'two lines with connector', [(0, 1), (1, 2), (2, 3), (1, 4), (3, 4)]))      
