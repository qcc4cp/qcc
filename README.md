...
*   If you have access to *Docker*, the corresponding simple instructions are [here](https://github.com/qcc4cp/qcc/README.Docker.md)
*   Manual installation on *Linux* / Debian / Ubuntu are [here]((https://github.com/qcc4cp/qcc/README.Linux.md)
